...
from utils.model_lr import get_cache, get_level_cost
...
all_samples = pd.read_csv('raw_data/level_cost_lr.csv')
...
pkl.dump(Wcs, open('model/level_cache_lr.pkl', "wb"))
pkl.dump(Ws, open('model/level_cost_lr.pkl', "wb"))
