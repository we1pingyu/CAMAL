...
from utils.model_lr import get_cache_uniform, get_level_cost
...
all_samples = pd.read_csv('raw_data/level_cost_lr_uniform_ckpt.csv')
...
pkl.dump(Wcs, open('model/level_cache_lr_uniform.pkl', "wb"))
pkl.dump(Ws, open('model/level_cost_lr_uniform.pkl', "wb"))


# Wcs = pkl.load(open("model/level_cache_lr.pkl", "rb"))
# Ws = pkl.load(open("model/level_cost_lr.pkl", "rb"))
