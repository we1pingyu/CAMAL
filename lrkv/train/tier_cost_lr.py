...
from utils.model_lr import get_cache, get_tier_cost
...
all_samples = pd.read_csv('raw_data/al_tier_cost_lr.csv')
...
pkl.dump(Wcs, open('model/al_tier_cache_lr.pkl', "wb"))
pkl.dump(Ws, open('model/al_tier_cost_lr.pkl', "wb"))
