...
for num_sample in [100]:
    ...
    pkl.dump(Wcs, open(config["lr_model"]["level_lr_cache_model"], "wb"))
    pkl.dump(Ws, open(config["lr_model"]["level_lr_cost_model"], "wb"))
    ...
    try:
        ...
        print("=" * 50)
        print(np.mean(errors), np.mean(rerrors))
        pkl.dump(Wcs, open(config["lr_model"]["tier_lr_cache_model"], "wb"))
        pkl.dump(Ws, open(config["lr_model"]["tier_lr_cost_model"], "wb"))
