...
class NominalWorkloadTuning(object):
    ...
    def get_nominal_design(self, is_leveling_policy=None, workload=None):
        ...
        H_UPPER_LIM = (self.cost_func.M / self.cost_func.N) - 1
        # print(self.cost_func.M / self.cost_func.N, (one_mib_in_bits / self.cost_func.N))
        ...
        bounds = ((2, H_UPPER_LIM), (T_LOWER_LIM, T_UPPER_LIM))
        min_cost = np.inf
        design = {}
        minimizer_kwargs = {
            "method": "SLSQP",
