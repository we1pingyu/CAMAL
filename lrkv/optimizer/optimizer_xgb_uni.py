...
from utils.model_xgb import traverse_var_optimizer_uniform
from utils.model_lr import traverse_var_optimizer_uniform_lr
...
class Optimizer(object):
    ...
    def run(self):
        ...
        for workload in workloads:
            ...
            #         best_var,
            #         best_cost,
            #     ) = traverse_var_optimizer_uniform_lr(
        ...
        pd.DataFrame(df).to_csv('optimizer_data/xgb_optimizer_uni.csv')
