    ...
    def run(self):
        ...
        for workload in workloads:
            ...
            (
                ...
                best_var,
                best_cost,
            ) = model_lr.traverse_var_optimizer_uniform_T(
            ...
            (
                ...
                best_var,
                best_cost,
            ) = model_lr.traverse_var_optimizer_uniform_memory(
                level_cache_models, level_cost_models, z0, z1, q, w, N=N
            )
            row['is_leveling_policy'] = True
            (
            ...
            (
                ...
                _,
                best_cost,
            ) = model_xgb.traverse_var_optimizer_uniform_T(
            ...
            (
                ...
                _,
                best_cost,
            ) = model_xgb.traverse_var_optimizer_uniform_memory(
                level_cost_models, 1, z0, z1, q, w, N=N
            )
            row['is_leveling_policy'] = True
            (
        ...
        pd.DataFrame(df).to_csv('optimizer_data/optimizer_uniform_overall_split.csv')
