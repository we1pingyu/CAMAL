...
class Optimizer(object):
    ...
    def run(self):
        ...
        for workload in workloads:
            ...
            # print(row)
            df.append(row)
            pd.DataFrame(df).to_csv('optimizer_data/optimizer_uniform_ckpt.csv')
            ...
            # learned lr level optimizer
            row = copy.deepcopy(row)
            row['optimizer'] = 'lr_level'
            ...
            # learned lr tier optimizer
            row = copy.deepcopy(row)
            row['optimizer'] = 'lr_tier'
            ...
            print(
                f'tier_optimizer: best_T: {best_T}, best_h: {best_h}, best_ratio: {best_ratio},best_var: {best_var}, best_cost:{best_cost}'
            )
            row['T'] = int(best_T)
            row['h'] = best_h * best_ratio
            row['M'] = best_ratio * M
            ...
            # learned xgb level optimizer
            row = copy.deepcopy(row)
            row['optimizer'] = 'xgb_level'
            level_cost_models = pkl.load(
            ...
            # learned xgb tier optimizer
            row = copy.deepcopy(row)
            row['optimizer'] = 'xgb_tier'
            tier_cost_models = pkl.load(
            ...
            print(
                f'tier_optimizer: best_T: {best_T}, best_h: {best_h}, best_ratio: {best_ratio}, best_cost:{best_cost}'
            )
            row['T'] = int(best_T)
            row['h'] = best_h * best_ratio
            row['M'] = best_ratio * M
