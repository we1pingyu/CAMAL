...
# These workloads are designed following the principle of gradually shifting weights
# between different operations, covering a variety of application scenarios.
N = 1e7
E = 1024
Q = 200000
B = 4
...
class Optimizer(object):
    ...
    def run(self):
        ...
        pd.DataFrame(df).to_csv('optimizer_data/lr_optimizer_uniform_shift.csv')
