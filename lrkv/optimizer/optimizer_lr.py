...
class Optimizer(object):
    ...
    def run(self):
            ...
            for dist in ['uniform']:
                ...
                for skew in skews:
                    ...
                    level_cost_models = pkl.load(
                        open("model/level_cost_lr_uniform.pkl", "rb")
                    )
                    level_cache_models = pkl.load(
                        open("model/level_cache_lr_uniform.pkl", "rb")
                    )
                    tier_cost_models = pkl.load(open("model/tier_cost_lr_uniform.pkl", "rb"))
                    tier_cache_models = pkl.load(
                        open("model/tier_cache_lr_uniform.pkl", "rb")
                    )
                    (
                        best_T,
                        best_h,
        ...
        pd.DataFrame(df).to_csv('optimizer_data/lr_optimizer_uniform.csv')
