...
class Optimizer(object):
    ...
    def run(self):
        ...
        for i in range(0, 100):
            ...
            for num_samples in [20]:
                ...
                (
                    ...
                    level_cache_models, level_cost_models, z0, z1, q, w, N=N, M=M
                )
                row['is_leveling_policy'] = True
                ...
                o_h = best_h * N / 100
                n_h = max(1, 100 * (o_h - N / 100 * np.log(100)) / N)
                best_h = n_h
                print(
        ...
        pd.DataFrame(df).to_csv('optimizer_data/lr_optimizer_uniform_1e9.csv')
